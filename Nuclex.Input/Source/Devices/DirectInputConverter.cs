...
namespace Nuclex.Input.Devices {
  ...
  internal partial class DirectInputConverter {
    ...
    internal DirectInputConverter(SlimDX.DirectInput.Joystick joystick) {
    ...
    private void mapAxes(SlimDX.DirectInput.Joystick joystick) {
    ...
    private void mapSliders(SlimDX.DirectInput.Joystick joystick) {
